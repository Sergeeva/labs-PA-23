...
public:
    static void generate(int matrix_size, std::shared_ptr<Lock_free_queue<std::pair<Square_matrix, Square_matrix>>> save_queue);
    static void multiply(int thread_count, std::shared_ptr<Lock_free_queue<Square_matrix>> save_queue, std::shared_ptr<std::pair<Square_matrix, Square_matrix>> matrices);
