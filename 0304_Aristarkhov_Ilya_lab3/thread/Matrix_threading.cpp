...
void
Matrix_threading::generate(int matrix_size, std::shared_ptr<Lock_free_queue<std::pair<Square_matrix, Square_matrix>>> save_queue) {
...
void Matrix_threading::multiply(int thread_count, std::shared_ptr<Lock_free_queue<Square_matrix>> save_queue,
